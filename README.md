...
# Introduction
This is a mini application implementing REST CRUD operations with Pagination using ASP.Net Web Api 2 with ADO.NET(Raw SQL Queries and Stored
Procedures).
...
- [Asp Web Api 2 + NHibernate](https://github.com/melardev/.NetWebApiADO.NetCrudPagination)
